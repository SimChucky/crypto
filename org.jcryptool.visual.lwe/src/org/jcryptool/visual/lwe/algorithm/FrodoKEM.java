...
public class FrodoKEM {
    ...
    public static void main(String[] args) {
        FrodoKEM frodo = new FrodoKEM(AlgorithmParameters.frodo640());
        ...
        System.out.println("FrodoKEM 640");
        ...
        frodo.setParams(AlgorithmParameters.frodo976());
        frodo.createKeypair();
        ss1 = frodo.keyEncap();
        ss2 = frodo.keyDecap();
        if (!Arrays.equals(ss1, ss2)) {
        ...
        System.out.println("FrodoKEM 976");
        System.out.println("Auto-generated mu:\t" + Hex.toHexString(frodo.getMu()));
        System.out.println("Alices shared secret:\t" + Hex.toHexString(ss1));
        System.out.println("Bobs shared secret:\t" + Hex.toHexString(ss2)+"\n");
        
        frodo.setParams(AlgorithmParameters.frodo1344());
        frodo.createKeypair();
        ss1 = frodo.keyEncap();
        ss2 = frodo.keyDecap();
        if (!Arrays.equals(ss1, ss2)) {
        ...
        System.out.println("FrodoKEM 1344");
        System.out.println("Auto-generated mu:\t" + Hex.toHexString(frodo.getMu()));
        System.out.println("Alices shared secret:\t" + Hex.toHexString(ss1));
        System.out.println("Bobs shared secret:\t" + Hex.toHexString(ss2)+"\n");
    ...
    /**
     * Generate a public and secret key for the KEM
     */
    ...
    /**
     * FrodoKem Key Encapsulation Generate a random seed and produces a cyphertext. Returns shared
     * secret using the public key
     * 
    ...
    public byte[] keyEncap() {
        ...
        Epp = sampleMatrix(Arrays.copyOfRange(seed, lenSeed * 2, seed.length), params.nbar, params.nbar);
    ...
    /**
     * FrodoKem Key Decapsulation Return the shared secret from cyphertext using the secret key
     * 
     * @return shared secret as byte array
     */
    public byte[] keyDecap() {
        SHAKEDigest shake = new SHAKEDigest();
        byte[] sharedSecret = new byte[params.cryptoBytes];
    ...
    /**
     * Sample a value from the Gaussian noise distribution (CDF_TABLE)
     * @return integer sample value
     **/
    ...
    /** Encode a byte array to a m-by-n matrix 
    ...
    /** Decode a n-by-m matrix to a bit string (stored as a byte array)
